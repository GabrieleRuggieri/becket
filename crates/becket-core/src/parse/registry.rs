...
impl GrammarRegistry {
    ...
    /// Loads optional extension overrides from `becket.languages.toml`.
    ...
    /// Resolves a Becket language to a tree-sitter `Language` handle.
...
/// Optional language plugin configuration (`becket.languages.toml`).
